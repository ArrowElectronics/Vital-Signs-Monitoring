...
typedef enum M2M2_APP_COMMON_ALARM_STATUS_ENUM_t {
...
} M2M2_APP_COMMON_ALARM_STATUS_ENUM_t;
STATIC_ASSERT_PROJ(sizeof(M2M2_APP_COMMON_ALARM_STATUS_ENUM_t) == 1, INCORRECT_SIZE_M2M2_APP_COMMON_ALARM_STATUS_ENUM_t);

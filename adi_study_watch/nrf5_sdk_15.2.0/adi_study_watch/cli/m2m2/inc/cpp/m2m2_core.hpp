...
enum M2M2_ADDR_ENUM_t:uint16_t {
  M2M2_ADDR_UNDEFINED = 0,
  M2M2_ADDR_POST_OFFICE = 49152,
  M2M2_ADDR_EXTERNAL = 49153,
  M2M2_ADDR_SENSOR_ADPD = 49409,
  M2M2_ADDR_SENSOR_ADXL = 49410,
  M2M2_ADDR_SENSOR_AD7689 = 49411,
  M2M2_ADDR_SENSOR_AD5940 = 49412,
  M2M2_ADDR_SENSOR_ADPDCL = 49424,
  M2M2_ADDR_SENSOR_ADPD_STREAM = 49665,
  M2M2_ADDR_SENSOR_ADXL_STREAM = 49666,
  M2M2_ADDR_SENSOR_AD7689_STREAM = 49667,
...
static_assert(sizeof(M2M2_ADDR_ENUM_t) == 2, "Enum 'M2M2_ADDR_ENUM_t' has an incorrect size!");

enum M2M2_STATUS_ENUM_t:uint8_t {
  M2M2_OK = 0,
  M2M2_ERROR_INVALID_MAILBOX = 1,
  M2M2_ERROR_INVALID_ADDRESS = 2,
};
static_assert(sizeof(M2M2_STATUS_ENUM_t) == 1, "Enum 'M2M2_STATUS_ENUM_t' has an incorrect size!");
...
struct m2m2_hdr_t {
  ...
  uint16_t  length; 
  uint16_t  checksum; 
  uint8_t  data[1]; // NOTE: THIS FIELD IS INTENDED TO BE OF VARIABLE LENGTH! 
        // NOTE: Use offsetof(m2m2_hdr_t, data) instead of sizeof(m2m2_hdr_t)
};

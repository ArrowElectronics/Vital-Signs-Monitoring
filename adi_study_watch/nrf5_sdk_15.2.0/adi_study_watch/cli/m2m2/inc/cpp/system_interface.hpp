...
struct _m2m2_pm_sys_dg2502_sw_ctrl_cmd_t {
  uint8_t  command;
  uint8_t  status;
...
struct _m2m2_pm_sys_ldo_ctrl_cmd_t {
  uint8_t  command;
  uint8_t  status;
  uint8_t  ldo_num;
  uint8_t  ldo_enable;
...
struct _m2m2_pm_sys_chip_id_cmd_t {
  uint8_t  command;
  uint8_t  status;
...
struct _m2m2_pm_sys_cap_sense_test_cmd_t {
  uint8_t  command;
  uint8_t  status;
  uint8_t  enable;
} m2m2_pm_sys_cap_sense_test_cmd_t;

struct _m2m2_pm_sys_cap_sense_test_data_t {
  uint8_t  command;
  uint8_t  status;
...
struct _m2m2_hibernate_mode_status_resp_cmd_t{
  uint8_t  command;
  uint8_t  status;

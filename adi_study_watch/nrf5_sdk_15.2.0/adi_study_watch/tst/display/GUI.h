...
#define LCD_PIXELINDEX uint32_t
typedef struct {
  int              NumEntries;
  char             HasTrans;
...
void Display_icon(const GUI_BITMAP * icon,uint8_t x,uint8_t y);
/*********************************************************************
*
...
extern GUI_CONST_STORAGE GUI_FONT GUI_FontCambria64;
...
extern void Lcd_display_task_function (void * pvParameter);
#if defined(__cplusplus)

...
typedef enum {
  ...
  BIA_RANGE_SWEEP_FREQUENCY_ENABLE,
  BIA_FIXED_FREQUENCY_SWEEP_ENABLE,
  BIA_SWEEP_START_FREQUENCY,
  BIA_SWEEP_STOP_FREQUENCY,
  BIA_SWEEP_SWEEP_POINTS,
  BIA_SWEEP_SCALE_TYPE,
  BIA_SWEEP_INDEX,
  BIA_SWEEP_FIXED_FREQUENCY,
  BIA_SWEEP_VOLTAGE,
  BIA_LCFG_MAX,
} BIA_LCFG_t;

...
inline static bool _adi_osal_IsCurrentLevelISR( void )__attribute__((always_inline));
...
#elif defined(__SES_ARM)
inline static bool _adi_osal_IsMemoryAligned(const void *pMemory) __attribute__((always_inline));

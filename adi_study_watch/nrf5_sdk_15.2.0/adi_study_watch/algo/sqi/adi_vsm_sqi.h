...
#define ADI_SQI_VERSION_NUM 0x00010201 /* Current Version = 01.02.01 */
/*
...
*    1) sampling_freq -> ppg sampling frequency
*    2) ppg_data_chunk_length -> No. of samples to be passed 
*       to the algo per call
*   to be configured during instance creation,
*   passed as an argument to adi_vsm_sqi_create API
*/
typedef struct {
    uint8_t sampling_freq;
    uint16_t ppg_data_chunk_length;

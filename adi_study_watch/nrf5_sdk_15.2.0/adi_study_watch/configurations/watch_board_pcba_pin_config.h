 ...
 * ****************************************************************************
 */
#ifndef _WATCH_BOARD_PCBA_PIN_CONFIG_H_
#define _WATCH_BOARD_PCBA_PIN_CONFIG_H_
...
#define KEY_SELECT_PIN (34)     //changed for PCBA
#define KEY_NAVIGATIONPIN  (33) //changed for PCBA


#if 1
#define LCD_SPI_SS_3388_EN_PIN (26)  //changed for PCBA
#define LCD_SPI_MOSI_PIN       (4)   //changed for PCBA
#define LCD_SPI_SCK_PIN        (27)  //changed for PCBA
...
#define ADXL362_INT1_PIN           (45) //changed for PCBA
#define ADXL362_INT2_PIN           (5)

#define AD7156_TWI_SCL_PIN  (25)
#define AD7156_TWI_SDA_PIN  (32)
#define AD7156_OUT1_PIN  (38)
#define AD7156_OUT2_PIN  (39)

#define ADP5360_TWI_SCL_PIN  (25) //changed for PCBA
#define ADP5360_TWI_SDA_PIN  (32) //changed for PCBA
#define ADP5360_INT1_PIN      (35)
#define ADP5360_PGOOD_PIN    (36)
#define ADP5360_ENSD_PIN    (37)  //not in use for PCBA
...
#define PWR_OPTICAL_PIN  (43)  //changed for PCBA
#define PWE_EPHYZ_PIN    (44)  //changed for PCBA

//#define PWM_RESET_PIN    (10)
#define HARDWARE_RESET_PIN (18)
#endif //_WATCH_BOARD_PCBA_PIN_CONFIG_H_
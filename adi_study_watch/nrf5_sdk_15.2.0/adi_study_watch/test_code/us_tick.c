...
/*!
  ...
  -------------------------------------------------------------------------------------------------------------------------------------------------
  | Freq(Hz)  |   12.5   |   25   |   50  |    100   |   200   |   250   |   300   |  400   |   500   |  600   |   700  |   800  |  900  |   1000 |
  -------------------------------------------------------------------------------------------------------------------------------------------------
  -------------------------------------------------------------------------------------------------------------------------------------------------
  | Period(ms)|    80    |   40   |   20  |    10    |    5    |    4    |   3.33  |   2.5  |    2    |  1.66  |  1.428 |  1.25  |  1.11 |    1   |
  -------------------------------------------------------------------------------------------------------------------------------------------------
  | Pulse     |    40    |   20   |   10  |    5     |   2.5   |    2    |  1.66   |  1.25  |    1    |  0.83  |  0.714 |  0.625 | 0.555 |   0.5  |
  | width(ms) |          |        |       |          |         |         |         |        |         |        |        |        |       |        |
  -------------------------------------------------------------------------------------------------------------------------------------------------
...
#else
#define TRIGGER_FREQ_STEPS  14u
uint16_t gaExtTriggerFreq[TRIGGER_FREQ_STEPS]={12,25,50,100,200,250,300,400,500,600,700,800,900,1000};
